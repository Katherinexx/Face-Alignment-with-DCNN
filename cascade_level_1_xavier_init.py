...
conv1_weights = tf.get_variable("conv1_weights", shape=[3,3,NUM_CHANNELS,32],
           initializer=tf.contrib.layers.xavier_initializer_conv2d())
conv1_biases = tf.get_variable("conv1_biases", shape=[32],
           initializer=tf.contrib.layers.xavier_initializer())


conv2_weights = tf.get_variable("conv2_weights", shape=[3,3,32,64],
           initializer=tf.contrib.layers.xavier_initializer_conv2d())
conv2_biases = tf.get_variable("conv2_biases", shape=[64],
           initializer=tf.contrib.layers.xavier_initializer())


conv3_weights = tf.get_variable("conv3_weights", shape=[3,3,64,64],
           initializer=tf.contrib.layers.xavier_initializer_conv2d())
conv3_biases = tf.get_variable("conv3_biases", shape=[64],
           initializer=tf.contrib.layers.xavier_initializer())


conv4_weights = tf.get_variable("conv4_weights", shape=[3,3,64,64],
           initializer=tf.contrib.layers.xavier_initializer_conv2d())
conv4_biases = tf.get_variable("conv4_biases", shape=[64],
           initializer=tf.contrib.layers.xavier_initializer())


conv5_weights = tf.get_variable("conv5_weights", shape=[3,3,64,64],
           initializer=tf.contrib.layers.xavier_initializer_conv2d())
conv5_biases = tf.get_variable("conv5_biases", shape=[64],
           initializer=tf.contrib.layers.xavier_initializer())


conv6_weights = tf.get_variable("conv6_weights", shape=[3,3,64,128],
           initializer=tf.contrib.layers.xavier_initializer_conv2d())
conv6_biases = tf.get_variable("conv6_biases", shape=[128],
           initializer=tf.contrib.layers.xavier_initializer())


conv7_weights = tf.get_variable("conv7_weights", shape=[3,3,128,128],
           initializer=tf.contrib.layers.xavier_initializer_conv2d())
conv7_biases = tf.get_variable("conv7_biases", shape=[128],
           initializer=tf.contrib.layers.xavier_initializer())


conv8_weights = tf.get_variable("conv8_weights", shape=[3,3,128,256],
           initializer=tf.contrib.layers.xavier_initializer_conv2d())
conv8_biases = tf.get_variable("conv8_biases", shape=[256],
           initializer=tf.contrib.layers.xavier_initializer())


fc1_weights = tf.get_variable("fc1_weights", shape=[IMAGE_SIZE // 16 * IMAGE_SIZE // 16 * 256,1024],
           initializer=tf.contrib.layers.xavier_initializer())
fc1_biases = tf.get_variable("fc1_biases", shape=[1024],
           initializer=tf.contrib.layers.xavier_initializer())


fc2_weights = tf.get_variable("fc2_weights", shape=[1024, 2*N_POINTS],
           initializer=tf.contrib.layers.xavier_initializer())
fc2_biases = tf.get_variable("fc2_biases", shape=[2*N_POINTS],
           initializer=tf.contrib.layers.xavier_initializer())
...
with tf.Session() as sess:
	# Tensorboard
	writer = tf.train.SummaryWriter("./logs/xavier_logs",sess.graph)
	...
	saver.save(sess,"./model/sigmoid_250epoch_0001_Xavier.ckpt")
	print ('Model saved')
